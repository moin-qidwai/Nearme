...
public class LocationFetchService extends Service {
    ...
    public void onCreate() {
        ...
        Runnable r = new Runnable() {
            ...
            @Override
            public void run() {
                Cursor userTempRelationCursor = userRelationDbHelper.fetchAllRelations();
                if(userTempRelationCursor.getCount() > 0)
                {
                    ...
                    try {
                        if (retObj.getInt("status") == 1)
                        {
                            ...
                            sendResult("success", targetIds, lats, lons);
                            stopSelf();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
            ...
            public void sendResult(String message, CharSequence[] targetIds, CharSequence[] lats, CharSequence[] lons) {
