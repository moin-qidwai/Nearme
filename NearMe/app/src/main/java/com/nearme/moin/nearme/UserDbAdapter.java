...
public class UserDbAdapter {
    ...
    public static final String KEY_GCMID = "gcm_regid";
    ...
    private static final String DATABASE_CREATE =
        ...
        + "userid integer not null, name text, number text not null, country text not null, display_name text, gcm_regid text);";
     ...
     */
    public long createUser(int userId, String name, String number, String country, String displayName, String gcmId) {
        ...
        initialValues.put(KEY_GCMID, gcmId);

        Log.e("dbadapter", "Name: "+name+" number: "+number+" userid: "+userId+" country: "+country+" displayname: "+displayName+" gcmId "+gcmId);
    ...
    public Cursor fetchAllUsers() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_USERID, KEY_NAME,
                KEY_NUMBER, KEY_COUNTRY, KEY_DISPLAYNAME, KEY_GCMID}, null, null, null, null, null);
    }
    ...
    public Cursor fetchUser(long rowId) throws SQLException {
        ...
        Cursor mCursor =
            ...
            mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                            KEY_NAME, KEY_NUMBER, KEY_COUNTRY, KEY_DISPLAYNAME, KEY_GCMID}, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
    ...
    public Cursor fetchUser(int userId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID, KEY_USERID,
                                KEY_NAME, KEY_NUMBER, KEY_COUNTRY, KEY_DISPLAYNAME, KEY_GCMID}, KEY_USERID + "=" + userId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateUser(long rowId, String name, String number, String country, String displayName, String gcmId) {
        ContentValues args = new ContentValues();
        args.put(KEY_NAME, name);
        args.put(KEY_NUMBER, number);
        args.put(KEY_COUNTRY, country);
        args.put(KEY_DISPLAYNAME, displayName);
        args.put(KEY_GCMID, gcmId);
     ...
     * @return true if the note was successfully updated, false otherwise
     */
    public boolean updateUser(int userId, String name, String number, String country, String displayName, String gcmId) {
        ContentValues args = new ContentValues();
        args.put(KEY_NAME, name);
        args.put(KEY_NUMBER, number);
        args.put(KEY_COUNTRY, country);
